        ...
        <div className="w-2/3 mx-auto">
            <Card className="p-4 shadow-lg rounded-lg border border-green-950">
                ...
                <CardTitle className="flex items-center space-x-4">
                    ...
                    <button className="btn bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl w-20 h-10">
                    Post
                    </button>
                </CardTitle>
                </CardHeader>
                ...
                <Card className="p-5 shadow-lg rounded-lg border border-green-950">
                    ...
                    <div className="mt-4">
                        <p className="leading-relaxed">
                            Lpsum dolor sit amet consectetur adipisicing elit. Vitae
                        ...
                        <div className="flex items-center space-x-2">
                            <Link to="Comment">
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    className="bi bi-chat-fill fill-blue-600 h-6 w-6"
                                    viewBox="0 0 16 16"
                                >
